            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                ...
                <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-3 sm:gap-3">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md border border-transparent bg-hyper-purple-primary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-hyper-blue-secondary sm:col-start-2 sm:col-span-2 sm:text-sm"
                    onClick={(e) => createHyperlink(e)}
                    disabled={linksMutation.isLoading}
                  >
                    {linksMutation.isLoading ? (
                      <div
                      ...
                      >
                        <svg
                          aria-hidden="true"
                          class={`w-5 h-5 mr-2 text-gray-200 animate-spin dark:white fill-hyper-purple-primary`}
                          viewBox="0 0 100 101"
                          fill="none"
