...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Kreative Hyperlink</title>
      ...
      <main>
        ...
        <div className="mx-auto max-w-7xl pb-24 px-6 lg:px-8" aria-label="Top">
          <h1 className="text-2xl font-bold pb-6 pt-6">Privacy Policy</h1>
          ...
          <h1 className="text-2xl font-bold pb-6 pt-6">Contact Us</h1>
          <p>
